...
export default [
  {
    ...
    // v1/ergogen/ reaches them again through symlinks.
    ignores: [
      "node_modules/**",
      "dist/**",
  ...
  //
  // No column limit, unlike the other JavaScript here. Almost every line is
  // KiCad s-expression inside a template literal, and a break there is a
  // newline in the footprint the build emits rather than a wrapped source line.
  {
